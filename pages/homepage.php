      ...
      <div class="jumbotron jumbotron2">
        <div style="color:red">
          ...
          <div style="padding-top: 10%;">
            ...
            <button type="button" class="btn btn-lg btn-success btn-edited" name="View_Transcript" onclick="window.location='transcript.php';" style="margin-left: 16%;">View Transcript</button>
          </div>
          <div style="padding-top: 10%;">
            <button type="button" class="btn btn-lg btn-success btn-edited" name="Contact_Advisor" onclick="window.location='contactAdvisor.php';" style="margin-left: 39%;">Contact Advisor</button>
          </div>
