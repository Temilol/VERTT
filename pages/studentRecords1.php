                ...
                <div class="col-sm-9">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home">
                            <hr>
                              <form class="form" method="POST" action="advisorReview.php" id="form">                              
                                  ...
                                  <div class="form-group">
                                     <div class="col-xs-12">
                                          <br>
                                          <button class="btn btn-lg btn-success" id="get_transcript" type="submit"><i class="glyphicon glyphicon-ok-sign"></i> Get Proposed Schedule</button>
                                      </div>
                                  </div>
                            </form>
                            <hr>
